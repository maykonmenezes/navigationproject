...
public class SamplesActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* items.add(new Sample("Indoor positioning", es.situm.gettingstarted.common.selectbuilding.SelectBuildingActivity.createIntent(this, PositioningActivity.class)));
        ...
        items.add(new Sample("Mostrar posição no mapa", es.situm.gettingstarted.common.selectbuilding.SelectBuildingActivity.createIntent(this, DrawPositionActivity.class)));
//        items.add(new Sample("Mostrar pontos no mapa", new Intent(this, DrawPoisActivity.class)));
        items.add(new Sample("Traçar rota entre dois pontos",es.situm.gettingstarted.common.selectbuilding.SelectBuildingActivity.createIntent(this, DrawRouteActivity.class)));
